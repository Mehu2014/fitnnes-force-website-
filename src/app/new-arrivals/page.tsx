  ...
  return (
    <div className="min-h-screen bg-dark-900 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <h1 className="text-4xl font-heading font-bold text-white mb-4">New Arrivals</h1>
        <p className="text-gray-400">Discover our latest and greatest fitness equipment.</p>
        
        <div className="mt-12 text-center py-20 bg-dark-200 rounded-2xl border border-dark-100">
          <h2 className="text-xl font-bold text-white mb-2">Coming Soon</h2>
          <p className="text-gray-400">We are updating our catalog with new products. Check back soon!</p>
